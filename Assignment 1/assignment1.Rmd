...
summary(fit1)
```
The coefficient for \texttt{sameGender} is significantly different from 0. This is coherent with the plot, where we can see clusters according to the gender.
