...
(4) We use the \texttt{gof} function and consider criteria which were not taken into consideration while fitting the model.
...
(5) Considering the summary, the estimated parameters are significant, except the fifth. The negative value for the edge parameter is coherent to what we expect for social networks (the network is sparse).
